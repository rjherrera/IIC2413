    ...
    <div class="main-content">
      <div class="ui segment">
        ...
        <h1 class="ui center aligned dividing header">
          <div class="content">
            <?php $nombre_s = nombre_serie($_GET['id']); echo $nombre_s;?> : <?php $nombre_c = nombre_capitulo($_GET['id']); echo $nombre_c;?>
        ...
        <div id="video" class="ui embed" data-url="http://www.youtube.com/embed/dQw4w9WgXcQ" data-placeholder="static/img/<?php nombre_serie($_GET['id']);?>.jpg">
          <button id="overlay_button" class="fluid ui button" style="position:absolute;top:0;left:0;width:100%;height:100%;">Presione para reproducir (gastará 1/4 de "visto")</button>
        </div>
        <div class="ui horizontal divider">Información</div>
        <div class="ui inverted segment">
          <div class="ui items">
            <?php item_serie_descripcion($_GET['id']); ?>
          </div>
        </div>
      </div>
      <div class="ui segment">
        ...
        <div class="ui minimal comments" style="max-width:100%">
          ...
          <?php if ($_SESSION['type'] == 2) {
              ...
              <div class='ui minimal comments' style='max-width:100%'>";
              mensajes_serie($_SESSION['username'],$_GET['id']);
              echo "<h4 class='ui dividing header'>Enviar mensaje sobre el capitulo a un grupo o usuario</h2>
                ...
                <form class='ui fluid reply form' id='form_message' onsubmit='return false;'>
                  ...
                  <input name='nombre_p' type='hidden' value='$nombre_s:$nombre_c'>
                  <input name='nombre_u' type='hidden' value='$nombre_u'>
                  <div class='field'>
                    <textarea name='mensaje'></textarea>
                  </div>
                  <p><i>* Al mensaje se le antepondrá el nombre del capítulo.</i></p>
